...
export default class Ellipse extends React.Component{
    ...
    myRef;
    componentDidMount() {
        this.setState({condition:this.props.condition,fillStyle:this.props.fillStyle,
            strokeStyle:this.props.strokeStyle,lineWidth:this.props.lineWidth,rate:this.props.rate});
    ...
    draw=(width,height)=>{
        ...
        cxt.ellipse(width/2, height/2, Math.abs(width-12)/2,
            Math.abs(height-12)/2, 0, 0, Math.PI * 2);
