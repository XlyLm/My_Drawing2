...
export default class Octagon extends React.Component{
    state={
        location:{
            x:0,
            y:0
    ...
    draw=(width,height)=>{
        ...
        cxt.moveTo(width/3,6);
        cxt.lineTo(2*width/3,6);
        cxt.lineTo(width-6,height/3);
        cxt.lineTo(width-6,2*height/3);
        cxt.lineTo(2*width/3,height-6);
        cxt.lineTo(width/3,height-6);
        cxt.lineTo(6,2*height/3);
        cxt.lineTo(6,height/3);
